...
import 'package:untitled/NotesPage.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: noteHeading.length > 0
          ? buildNotes()
          : Center(child: Text("Нажміть на кнопку щоб додати нотатки")),
                      ...
                      TextFormField(
                        ...
                        validator: (String noteHeading) {
                          if (noteHeading.isEmpty) {
                            ...
                            return "Старайтесь не допускати пустих пробілів";
                          }
                        },
                          ...
                          child: TextFormField(
                            ...
                            validator: (String noteDescription) {
                              if (noteDescription.isEmpty) {
                                return "Будь ласка, введіть опис нотатка";
